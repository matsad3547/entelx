...
const Logo = ({
  ...
  return (
    ...
    <g>
      ...
      <polygon className="cls-3" points="54.59 51.52 82.77 51.52 66.15 103.7 29.34 103.7 54.59 51.52"/>
      <polygon className="cls-4" points="99.61 0.58 84.81 45.36 57.47 45.36 79 0.58 99.61 0.58"/>
    </g>
    </svg>
  )
}
