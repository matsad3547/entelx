...
const Contact = () => (
  ...
  <PublicPageTemplate
    ...
    <div style={styles.root}>
      <p style={styles.text}>As I've detailed <a  href="/about" target="_blank" rel="noopener noreferrer" style={styles.link}>here</a>, the idea of this project has be rattling around my brain for the last three years, even prior to changing careers to software development.  In fact, building something like this was among the reasons I undertook that change.</p>
